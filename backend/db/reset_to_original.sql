-- Reset database to original state with just the 5 original users and first pool
-- This clears all data and reloads the original seed data
...
-- Add all original users to the pool
...
-- Initialize every user to 1000 points in the original pool
...
-- Update second round games to SCHEDULED status (as per previous requirement)
UPDATE mm.games
